...
const ShopCart_Home = () => {
  return (
    <>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-3">
            <div className="section-2_product my-10 mx-5">
              ...
              <div className="product_name-price flex justify-between px-5 py-2 mt-2">
      ...
      {/* Section-4 */}
      <div className="section-2 mt-20 my-10">
        <div className="container mx-auto">
          <div className="title-Text">
          ...
          <div className="saveProduct mt-10">
            <div className="grid grid-cols-4">
              <div className="productDetails bg-[#f2e4d9] rounded-xl overflow-hidden mx-7">
              ...
              <div className="productDetails bg-[#f9dcdc] rounded-xl overflow-hidden mx-7">
                <div className="text p-5">
                  <p className="text-xl font-semibold">Save</p>
                  <div className="price flex">
                    <h1 className="text-[#cb9917] text-3xl font-semibold">$</h1>
              ...
              <div className="productDetails bg-[#d2f7ec] rounded-xl overflow-hidden mx-7">
                <div className="text p-5">
                  <p className="text-xl font-semibold">Save</p>
                  <div className="price flex">
                    <h1 className="text-[#cb9917] text-3xl font-semibold">$</h1>
